...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-r from-[#5F6F52] to-[#A9B388] shadow-lg sticky top-0 z-[100]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            {/* CTA Button */}
            <button className="px-6 py-2 bg-white/20 backdrop-blur-sm text-white rounded-lg font-semibold hover:bg-white/30 transition-all border border-white/30">
              Get Quote
            </button>
          </div>
